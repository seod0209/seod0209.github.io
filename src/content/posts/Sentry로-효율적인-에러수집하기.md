...
date: 2024-01-03
categories: ["Frontend"]
tags: ["sentry", "nextjs", "error-monitoring"]
---
...
또한 소스맵이 없는 에러의 경우 번들링되고 minify된 코드가 보이기 때문에 디버깅이 쉽지 않다.
...
### 2. git push 시 Sentry에 source map 업로드 하기.
