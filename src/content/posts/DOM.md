...
1- 1. 개념 및 의의
DOM(돔)이란 HTML·XML 문서를 구조화한 객체 표현이자, 프로그래밍 언어가 문서에 접근하고 조작할 수 있게 해주는 프로그래밍 인터페이스다. 흔히 트리 구조로 그리지만 마크업 텍스트와 1:1로 대응하는 것은 아니며, 브라우저가 파싱하면서 누락·오류를 보정(예: 빠진 태그 삽입)하는 정규화를 거쳐 생성된다.
JavaScript는 이 model로 웹 페이지에 접근하고, 페이지를 수정할 수 있다.
DOM은 HTML인 웹페이지와 스크립팅언어(JavaScript)를 서로 연결하는 역할을 한다.

[https://storage.googleapis.com/replit/images/1554697886215_4cc30fbcee76455dc6061ef47279a2a1.png](https://storage.googleapis.com/replit/images/1554697886215_4cc30fbcee76455dc6061ef47279a2a1.png)
...
[https://storage.googleapis.com/replit/images/1554696792180_4109f19a3b5f31133dd4ecde0659adb5.png](https://storage.googleapis.com/replit/images/1554696792180_4109f19a3b5f31133dd4ecde0659adb5.png)
...
> ⚠️ `innerHTML`에 사용자 입력처럼 신뢰할 수 없는 문자열을 그대로 대입하면 스크립트가 삽입되어 XSS 공격에 노출될 수 있다. 단순 텍스트만 넣을 때는 `textContent`를 사용하는 것이 안전하다.
